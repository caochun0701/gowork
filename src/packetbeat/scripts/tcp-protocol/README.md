...
```
python ${GOPATH}/src/packetbeat/scripts/create_tcp_protocol.py
```
...
"packetbeat/protos/echo"` to the import list in
`$GOPATH/src/packetbeat/include/list.go`.
...
`$GOPATH/src/packetbeat/protos` and importing module in
`$GOPATH/src/packetbeat/include/list.go`.
